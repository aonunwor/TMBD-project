const popularTvShowsContainer = document.querySelector("#popular-tv-shows-container");
...
const renderPopularTvShows =(data) =>{
	const tvShows = data.results;
	const tvShowsBlock = createTvShowsContainer(tvShows);
	popularTvShowsContainer.appendChild(tvShowsBlock);
	toClearExtras();
}
...
const getPopularTvShows =()=>{
	...
	requestTvShowsUrl(url, renderPopularTvShows, handleError);
}
getPopularTvShows();
